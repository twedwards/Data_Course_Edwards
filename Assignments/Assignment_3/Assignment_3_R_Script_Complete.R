...
plot(x=dat$Headwidth..mm., y=dat$Mass) #This shoes up as scatter plotbecause they are both numeric classes
plot(x=dat$Size.class, y=dat$Mass) #This shows up as a box and whisker because Size.class is a factor -
# and Mass is numeric
...
jpeg("./testimage.jpg") #this command opens the door to start writing things to the file with the name you give it.
#everything after the above commande will be added, you can "close that door" by running the dev.off() command below.
plot(nums, main = "My Title", xlab = "My axis label", ylab = "My other axis label")

dev.off() #no need for a file name inside the parentheses. Any "open doors" or connections will be closed with this base command.
...
save_path = "/Users/Tyler/Desktop/Data_Course_Edwards/Assignments/Assignment_3/EDWARDS_tyler_file.csv"
